        ...
        if (typeof settings.filterDropdown[0] !== 'undefined') {
            ...
            $.each(settings.filterDropdown, function (index, dropdown) {
                ...
                $dropdown.change(function () {
					...
					$('.btn').attr("dojoid",$selector.val());
					$('.reminderSlipall').attr("href",'https://ukkgk.com/Admin/reminderSlipall/'+$selector.val());
            ...
            function _load_template(settings) {
                ...
                var template = "<div class='app-modal loading'>\
                                ...
                                <div class='app-modal-body'>\
                                    ...
                                    <div class='app-modal-close hide visible-xs'><span>&times;</span></div>\
                                        <i class='fa fa-expand expand hidden-xs'></i>\
                                        <div class='app-modal-content-area'>\
                                        </div>\
                                    </div>\
                                    <div class='app-modal-sidebar hidden-xs'>\
